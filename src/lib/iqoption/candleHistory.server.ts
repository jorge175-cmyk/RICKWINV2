// Persistent candle cache backing the mirror/replay scan. Without this, every
// scan re-downloads the full history from IQ Option from scratch, which is
// both slow and wasteful — old candles never change once their period closes.
...
export async function saveCandles(asset: string, timeframe: string, candles: StoredCandle[]): Promise<void> {
